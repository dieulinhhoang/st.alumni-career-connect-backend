...
export const DEFAULT_EMPLOYMENT_SURVEY_QUESTIONS: DefaultSurveyQuestionSeed[] = [
  ...
  { questionKey: 'hn98q4', questionText: 'Giới tính', questionType: 'radio', options: [{ id: 'cdoc70', label: 'Nam' }, { id: 'yd1l93', label: 'Nữ' }, { id: '3zcpfy', label: 'Khác' }], isRequired: 1, sectionKey: 'mt7xev', orderIndex: 2, reportFieldKey: 'gender', showInChart: 0, chartType: null, reportTemplate: 'mau03', excelColumn: 'gender' },
