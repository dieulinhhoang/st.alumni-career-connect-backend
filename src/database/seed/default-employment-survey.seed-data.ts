...
export const DEFAULT_EMPLOYMENT_SURVEY_QUESTIONS: DefaultSurveyQuestionSeed[] = [
  ...
  { questionKey: 'mpju4t', questionText: 'Tên đơn vị tuyển dụng', questionType: 'text', options: [], isRequired: 1, sectionKey: 'mt7xev', orderIndex: 11, reportFieldKey: null, showInChart: 0, chartType: null, reportTemplate: null, excelColumn: 'currentCompany' },
  ...
  { questionKey: 'rao44c', questionText: ' Chức vụ, vị trí việc làm', questionType: 'text', options: [], isRequired: 1, sectionKey: 'mt7xev', orderIndex: 14, reportFieldKey: null, showInChart: 0, chartType: null, reportTemplate: null, excelColumn: 'currentPosition' },
